"""Fixed official OAuth and scoped corporate directory endpoints.

Browser OAuth: opensource.dingtalk.com/developerpedia/docs/develop/permission/token/browser/get_user_app_token_browser/
Legacy directory form requests: developer.alibaba.com/docs/api.htm?apiId=52234
and apiId=52243. Tokens stay in request bodies/headers, never URLs or logs.
"""
