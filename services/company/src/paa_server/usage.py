"""Request accounting; quota estimates and provider-reported usage stay separate."""
import asyncio
...
from .models import Company, ModelUsage, now
from .model_provider import safe_error, token_usage
from .queries import cursor_decode, cursor_encode, period_range
...
async def interrupt_usage(db, job):
    ...
    for row in rows:
        ...
        # Process death gives no reliable request duration; do not invent one.
