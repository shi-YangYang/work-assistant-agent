...
当前 [Spec 009：公司级模型服务管理](../specs/spec-009-company-model-services/spec.md)：让管理员在 Web 管理多家服务、按工作助手／报告／语音分配模型，并补齐既有流程的真实服务联调。实施与独立工程复验已通过，状态 ACCEPTANCE；下一步是用户配置真实服务后联调，不包含正式云部署。
