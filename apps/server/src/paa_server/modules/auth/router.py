...
from paa_server.modules.auth.models import DingTalkAuthorization, LoginAttempt
from paa_server.modules.auth.schemas import Login, Password
from paa_server.modules.auth.sessions import COOKIE, issue_session, limit_authenticated_request, passwords, revoke_member, verify_password
...
async def password(body: Password, response: Response, request: Request, limited=Depends(password_rate), actor=AUTH, db=DB):
    from paa_server.modules.auth.dingtalk.service import proof, clear_auth_cookies
