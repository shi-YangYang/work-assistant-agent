...
from paa_server.http.desktop_dependencies import DESKTOP
from paa_server.integrations.media import audio_mime
from paa_server.modules.attachments.documents import safe_name
from paa_server.modules.members.models import Member
from paa_server.modules.voiceprints.models import Voiceprint
from paa_server.modules.voiceprints.service import MAX_BYTES, dto, enrollment, private_path, valid_templates
