...
from paa_server.integrations.models.samples import image_sample
from paa_server.integrations.models.transport import ProviderError, safe_error
from paa_server.modules.model_services.models import ModelCheck, ModelService, ModelServiceRevision, ModelUsage
...
async def reserve_probe(sessions, settings, actor, choice=None):
    async with sessions.begin() as db:
        from paa_server.modules.model_services.usage import usage_fields
    ...
    try:
        ...
        if body.purpose == 'asr':
            ...
            if body.purpose == 'report':
                ...
                from paa_server.modules.reports.parsing import parse_report
