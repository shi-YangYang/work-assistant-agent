...
from paa_server.modules.team.sources import bounded_content as business_bounded_content, canonical_token as business_canonical_token
from paa_server.modules.work.models import WorkItem
from paa_server.security.access import resolve as business_resolve, valid as business_valid
...
async def authorize_intent(context, proposal):
    ...
    """
    from paa_server.agent.model import BoundedChatModel
    ...
    async with context.sessions.begin() as db:
        ...
        from paa_server.agent.conversation_context import conversation_references, request_text
