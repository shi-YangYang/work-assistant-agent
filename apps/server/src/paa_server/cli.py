...
from paa_server.core.input_rules import PASSWORD_RULES
...
async def prepare_model_key():
    from paa_server.security.secrets import initialize_key, SecretUnavailable
    from paa_server.modules.model_services.models import ModelServiceRevision
    from paa_server.modules.auth.models import DingTalkConfig
    settings = Settings()
