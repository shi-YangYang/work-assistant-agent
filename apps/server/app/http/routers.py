...
from app.modules.auth.desktop_router import router as auth_desktop_router
from app.modules.auth.dingtalk.router import router as auth_dingtalk_router
...
from app.modules.team.workspace_router import router as team_workspace_router
from app.modules.voiceprints.router import router as voiceprints_router
