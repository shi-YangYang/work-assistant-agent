...
async def prepare_model_key():
    from app.security.secrets import initialize_key, SecretUnavailable
    from app.modules.model_services.models import ModelServiceRevision
    from app.modules.auth.models import DingTalkConfig
    settings = Settings()
...
def main():
    ...
    if action == 'migrate':
        ...
        raise SystemExit('Usage: python -m app.cli migrate | bootstrap-admin')
